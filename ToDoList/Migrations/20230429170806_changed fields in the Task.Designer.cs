...
namespace ToDoList.Migrations
{
    ...
    [Migration("20230429170806_changed fields in the Task")]
    partial class changedfieldsintheTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoList.Models.Task", b =>
                {
                    b.HasOne("ToDoList.Models.User", "Executor")
                        .WithMany()
                        .HasForeignKey("ExecutorId");

                    b.HasOne("ToDoList.Models.User", "Manager")
                        .WithMany()
